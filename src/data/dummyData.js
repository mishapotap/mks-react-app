				...
				value: [
					{
						...
						content: [
							{
								slug: "heading",
								value: "Испытательный модуль"
								},
								{
								slug: "modalInfo",
								value: {
									"symbol": 'BEAM',
									"start": '10 апреля 2016 г',
									"finish": '16 апреля 2016 г',
								}
								},
								{
								slug: "paragraph",
								value: "Надувной модуль BEAM создан частной компанией Bigelow Expandable Activity Module. Он предназначен для проживания и работы будущих экипажей орбитального комплекса. В течение двух лет модуль будет проходить испытания в космосе, цель которых - определить его реальные возможности для использования в космических полетах."
								},
						]
					},
					{
						...
						content: [
							{
								slug: "paragraph",
								value: "Модуль имеет цилиндрическую форму. Стенки модуля состоят из нескольких слоев. Внешний слой состоит из листов алюминиевой фольги, отделённых друг от друга небольшими промежутками. Этот слой выполняет функцию обеспечения теплоизоляции и обеспечения защиты от микрометеоритов. Следующий слой состоит из тонких листов металла – он предназначен для защиты модуля от более крупных метеоритов. Внутренние слои состоят из нескольких слоев полимерной ткани Vectran, этот материал имеет прочность в два раза выше, чем у кевлара. Эти слои выступают, как защита от внешних и от внутренних воздействий. Несмотря на свою сложную структуру, один квадратный метр такой многослойной стенки весит всего 25 килограмм. Для сравнения квадратный метр аналогичного отсека МКС, выполненного по классическим технологиям строительства, весит около ста килограмм."
								},
								{
								slug: "paragraph",
								value: "Надувной модуль BEAM был доставлен на МКС в негерметичном отсеке грузового корабля «Дрэгон» (Dragon) и 16 апреля с помощью автоматической руки-манипулятора «Канадарм 2» был пристыкован к модулю «Транквилити» на американском сегменте МКС."
								},
						]
					},
				]
